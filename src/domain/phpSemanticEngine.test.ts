...
`;
  ...
  it("resolves Laravel morph map targets from local class-string constants", () => {
    const source = `<?php
namespace App\\Models;
...
`;
  ...
  it("resolves Laravel morph map array constants with class-string constant values", () => {
    const source = `<?php
namespace App\\Models;
...
`;
  ...
  it("resolves Laravel morph map array constant aliases", () => {
    const source = `<?php
namespace App\\Models;
...
class AppServiceProvider
{
    ...
    private const ACTIVE_MORPH_MAP = self::MORPH_MAP;

    public function boot(): void
    {
        Relation::morphMap(self::ACTIVE_MORPH_MAP);
    }
}
