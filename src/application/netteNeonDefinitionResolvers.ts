import {
  neonParameterOffsetInSource,
  neonServiceOffsetInSource,
  neonServiceTypeInSource,
 ...
 */
export async function resolveNeonParameterDefinition(
 ...
 */
export async function resolveNeonServiceDefinition(
  context: NeonRequestContext<NeonDefinitionDependencies>,
  source: string,
  name: string,
): Promise<boolean> {
 ...
 */
export async function resolveNeonSetupMethodDefinition(
  context: NeonRequestContext<NeonDefinitionDependencies>,
  setupMethod: {
    methodName: string;
...
export async function resolveNeonServiceMethodDefinition(
  context: NeonRequestContext<NeonDefinitionDependencies>,
  source: string,
  serviceName: string,
  methodName: string,
