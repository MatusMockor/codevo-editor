...
describe("codevo token contract", () => {
  ...
  it("pins the radii, the type scale, the icon metrics and the Inter stack", () => {
    ...
    expect(codevoValue("--codevo-fs-hero")).toBe("26px");
    expect(codevoValue("--codevo-fs-title")).toBe("20px");
    expect(codevoValue("--codevo-fs-heading")).toBe("15px");
    expect(codevoValue("--codevo-fs-body")).toBe("13.5px");
    expect(codevoValue("--codevo-fs-ui")).toBe("13px");
    expect(codevoValue("--codevo-fs-meta")).toBe("12px");
    expect(codevoValue("--codevo-fs-small")).toBe("11px");
    expect(codevoValue("--codevo-fs-label")).toBe("10px");
